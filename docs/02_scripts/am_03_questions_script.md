...
The tripod method is an exemplary method from [Schreiben und Denken – sans souci](www.uni-potsdam.de/zessko/selbstlernen/schreibberatung) at the Universität Potsdam.
...
Example:
1. *The goal of this paper is to* determine how to support students who are writing academic texts in English as their second language.
