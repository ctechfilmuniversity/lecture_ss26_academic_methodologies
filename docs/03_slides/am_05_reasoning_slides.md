...
<br />
Example: *This software is bug-free.* vs. *This software is not bug-free.*
...
* Not every image has a photographer.
...
* AR feels better than VR. 

--

    * Not falsifiable, as “feels better” is not well defined.
...
* Come up with a falsifiable hypothesis.
    ...
    * Every image has a photographer
* Come up with a non-falsifiable hypothesis.
    * Human creation is always creative.
    * No tool is ever neutral.
    * Every AI output contains traces of human meaning, even when none was intended.
    * Lena is funny.
