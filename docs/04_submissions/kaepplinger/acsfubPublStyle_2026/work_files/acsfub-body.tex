...
% for the final version: add your name.
\author[K. Wolf ]
...
\teaser{
    \includegraphics[width=\linewidth]{work_files/img/teaser.pdf}
    \centering
...
\begin{figure}[htb]
  ...
  \includegraphics[width=.8\columnwidth]{work_files/img/cat_upsidedown.jpg}
...
\begin{figure*}[]
    \centering
    \includegraphics[width=.9\linewidth]{work_files/img/panda_in_tree}
...
\bibliography{work_files/acsfub-bib}
