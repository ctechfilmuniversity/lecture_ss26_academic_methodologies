...
## How I plan to answer my research question
...
- **Title:** Cuteness as a Mechanism of Access: The Hyperfeminine 
  Cyberdeck Community as a Case Study in Maker Culture
- **Teaser Image:** a contemporary hyperfeminine cyberdeck 
  (pastel, decorated, cute)
- **Abstract:** short summary of topic, RQ, and findings
- **Introduction**
  - broad context: big tech culture becoming more exclusionary
  - "counter-movement" emerging: cute, whimsical, hyperfeminine DIY
  - concrete examples: Creator Ube Boobey, TikTok tutorials, cyberdecks in handbags
  - research question
...
- **Methodology**
  - qualitative, descriptive approach
    - academic literature as theoretical framework
    - publicly available social media content as observational data
  - single case study + deductive content analysis
- **Main Body**
  - Theory: cuteness as mechanism
  - Case Study: describing the hyperfeminine cyberdeck community
    - visual aesthetics of the builds
...
- **Possible Future Work**
  ...
  - longitudinal observation (community moves fast)
- **Conclusion**
  - summary of key arguments
  - cuteness as entry mechanism and what this means for maker culture
- **Acknowledgements**
